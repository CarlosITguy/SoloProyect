...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var topRatedTableViewCell2: UITableViewCell!
...
//        self.ubicationTextFieldOutlet.layer.cornerCurve =
    ...
    func setUp(){
        ...
        scrollTableBar.backgroundColor = .purple.withAlphaComponent(0.5)
        scrollTableBar.dataSource = self
        scrollTableBar.register(TopRatedTableViewCell.self, forCellReuseIdentifier: "topRatedCell")
...
extension ViewController : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            guard var cell = self.scrollTableBar.dequeueReusableCell(withIdentifier: "topRatedCell" , for: indexPath) as? TopRatedTableViewCell else {return UITableViewCell() }
